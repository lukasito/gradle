...
"""
        ...
        webClasspath.assertHasLibs('commons-lang3-3.0.jar', 'junit-4.12.jar', "guava-18.0.jar", 'hamcrest-core-1.3.jar') // TODO (donat) 'javax.servlet-api-3.1.0.jar' is part of provided configuration which is part of minusConfigurations in eclipse-wtp plugin
